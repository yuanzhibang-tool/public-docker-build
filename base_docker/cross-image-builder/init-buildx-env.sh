...
wget https://static-david-health-cn.oss-cn-beijing.aliyuncs.com/script/docker/docker-buildx-plugin_0.10.5-1%7Eubuntu.22.04%7Ejammy_amd64.deb
dpkg -i docker-buildx-plugin_0.10.5-1~ubuntu.22.04~jammy_amd64.deb
